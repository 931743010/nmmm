...
//     }
 ...
 public function reg2() {
    ...
    public function sendPhone(){
        ...
        $info = sendSMS($phone,"您的注册验证码是：【变量】。请不要把验证码泄露给其他人。如非本人操作，可不用理会！".$rand."，【索罗斯（中国）运营中心】",'');
        ...
        if(false){
            ...
            if ($data->create ( $data_arr )) {
                ...
                if(true){
                    ...
                    /*$this->ajaxReturn(array(
                            'msg' => "注册成功!<br>您的账号:".$data_P['phone']."<br>密码:".$data_P['password']."<br>第一次登入,请登录-会员网站-点击右上角-管理档案-修改个人资料和绑定个人信息！",
                            'error' => 0

                        )); */  
                    $this->success("注册成功!<br>您的账号:".$data_P['phone']."<br>密码:".$data_P['password']."<br>第一次登入,请登录-会员网站-点击右上角-管理档案-修改个人资料和绑定个人信息！",U('Login/login'));          
