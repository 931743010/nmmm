    ...
    <div class="container">
        <ul class="nav navbar-nav navbar-right" role="sub-navigation">
            <li class="dropdown" id="lang_nav">
                <span class="STYLE1"><a href="http://www.cngsoros.com">会员注册 |索罗斯(中国)欢迎您！</a> </span></li>           
        </ul>
  </div>
</header>
    ...
    <div class="innerContent">  
        <div class="row">
            <div class="col-md-12" style="max-width:800px">                                                                                             
                ...
                <form class="form-horizontal margin-none" name="register_form" action="<?php echo U('regadd');?>" method="post">                 
                
                    <div class="widget widget-body-white padding-none STYLE1">
                        <div class="widget-head">
                            <h4 class="heading">帐户详情</h4>
                        </div>
                        <div class="widget-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label">登录账号(手机)<span class="ast">*</span></label>
                                <div class="col-md-9"><input class="form-control" id="username" name="email" value="" type="text"/></div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9"> <input type="text" value="" id="phone" class="form-control" name="phone" maxlength="13"  required=""></div>
                            </div> 
                    ...
                    <div class="widget widget-body-white padding-none">                     
                        <div class="data-footer innerAll half text-right clearfix STYLE1" style="text-align:center; padding:10px;">
