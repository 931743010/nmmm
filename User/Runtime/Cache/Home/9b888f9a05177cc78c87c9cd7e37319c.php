...
<!--                                      <p class="help-block">
                                    ...
                                    <?php if($scheduleStatus == 1): ?><div class="form-group">
      ...
      <div class="col-md-9">
          <div class="widget">
            <div class="widget-head clearfix">
              <h4 class="heading STYLE1">索罗斯支出</h4>
            </div>
            <div class="widget-body innerAll overthrow STYLE1">
                      ...
                      <td>
                        ...
                        <?php if($o["pic"] != '0'): ?><a href="<?php echo ($o["pic"]); ?>" target="_blank">
                            <i style="font-size: 14px;wallet-colorr:#ff0000;display: inline-block;font: normal normal normal 14px/1 FontAwesome;">
                              付款凭证                            </i>                          </a><?php endif; ?>                      </td>
                      <td>
                        <?php echo (cx_user($o["g_user"])); ?>                      </td>
                      <td>
                ...
                <tbody>
                  <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr class="odd" role="row">
                      <td>
                        ...
                        <p class="text-center">S21830<?php echo ($o["id"]); ?></p>                      </td>
                      <td>
                        <?php if($o["zt"] == 0): ?>待付款<?php endif; ?>
                        <?php if($o["zt"] == 1): ?>已付款<?php endif; ?>
                        <?php if($o["zt"] == 2): ?><font color="#017F01">
                ...
                <div class="donateHead clearfix">
                  ...
                  <div class="title">
                    舍:索罗斯支出:
                      ...
                      P<?php echo (strtolower(substr(md5($v["id"]),0,6))); ?>                  </div>
                </div>
                <b>
                  参加者                </b>
                :<?php echo ($v["user_nc"]); ?>
                ...
                <div class="donateHead clearfix">
                  ...
                  <div class="title">
                    得:索罗斯收入:
                      ...
                      G<?php echo (strtolower(substr(md5($v["id"]),0,6))); ?>                  </div>
                </div>
                <b>
                  参加者                </b>
                :<?php echo ($v["user_nc"]); ?>
...
<div class="modal fade STYLE1" id="myModal5" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal fade STYLE1" id="myModal7" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="color-line">          </div>
          <div class="modal-header">
...
<div class="modal fade STYLE1" id="dialog-msg">
                ...
                <div class="btn-group btn-group-sm" id="upload_clone">
                  <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="input-group">
                      <div class="form-control col-md-3">                      </div>
...
<div class="modal fade STYLE1" id="dialog-confirm-confirm">
  <div class="modal-dialog">
...
<div class="modal fade STYLE1" id="dialog-report-confirm">
  <div class="modal-dialog">
...
<div class="modal fade STYLE1" id="dialog-photo">
  <div class="modal-dialog">
    <form name="cancel_order_form" method="post" action="">
      ...
      <div class="modal-content">
        <div class="modal-body np" id="image_div">        </div>
      </div>
    </form>
  </div>
</div>
...
<div class="modal fade STYLE1" id="myModa23" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
...
<div class="modal fade STYLE1" id="myModa24" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
  ...
  <div class="modal-dialog">
    <fieldset>
      <div class="modal-content STYLE1">
        ...
        <div class="modal-body np">
          <div id="message_foot">
            您已经完成了一个舍与得程序。请问您想继续索罗斯支出吗?          </div>
        </div>
        <footer class="modal-footer clearfix">
