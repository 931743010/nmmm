			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="widget">
						...
						<form class="form-horizontal margin-none" name="wallet_transfer_form" method="post" action="<?php echo U('Index/codezzcl');?>">				
							<fieldset>
								...
								<div class="widget-body">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<input name="xh" type="text" id="xh" class="form-control ">
																						<p class="help-block">您的未使用CODE排单币为：<strong class="green"><?php if($code_zs): echo ($code_zs); else: ?>0<?php endif; ?></strong></p>
																																</div>
									</div>
