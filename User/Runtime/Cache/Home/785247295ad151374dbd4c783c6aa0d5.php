                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body innerAll overthrow">
                                <table id="example" cellpadding="1" cellspacing="1" class="table table-bordered table-striped cus_datatable dataTable no-footer" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                    <thead>
                                    <tr role="row">
									<th class="sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="编号: activate to sort column ascending" style="width: 103px;">编号</th>
									<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="用户: activate to sort column ascending" style="width: 103px;">使用者</th>
									<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="PIN码: activate to sort column ascending" style="width: 120px;">排单币</th>
									<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="状态: activate to sort column ascending" style="width: 103px;">状态</th>
									<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="生成时间: activate to sort column ascending" style="width: 164px;">生成时间</th>
                      ...
                      <td><?php echo ($v["onwer"]); ?></td>
                      <td><?php echo ($v["code"]); ?></td>
                      <td>
					  <?php if($v["status"] == '1'): ?>未使用<?php endif; ?>
					  <?php if($v["status"] == '2'): ?>已使用<?php endif; ?>
					  </td>
