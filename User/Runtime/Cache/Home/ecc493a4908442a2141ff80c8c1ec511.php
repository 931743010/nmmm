...
<div class="wrapper">
  ...
  <div class="widget">
    ...
    <div class="widget-body">
      ...
      <h1><img src="/bitStyle/images/nmm_logo_login.png" alt=" "></h1>
            
            
        <div class="alert alert-danger">
        <span class="STYLE1">用户名或密码不正确</span>。      </div>    
        ...
        <div class="row" style="text-align:center;">
          ...
          <div class="col-md-12">
            <input class="btn btn-block btn-primary" type="button" name="submit" value="登录" id="login_btn" />
            <a class="btn btn-block btn-success" type="button" name="submit"  id="login_btn" href="<?php echo U('Reg/index');?>" /><span class="STYLE1">注册</span></a>
            <a class="btn btn-block" type="button" name="submit"  id="login_btn" href="<?php echo U('Reg/forgot');?>" /><span class="STYLE1">忘记密码</a>
  ...
  <div class="copyright">
  © 索罗斯 （中国）<br>
	2016 George Soros China All Right Reserved</div>
</div>
