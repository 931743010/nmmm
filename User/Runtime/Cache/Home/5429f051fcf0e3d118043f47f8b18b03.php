...
<link href='http://fonts.googleapis.com/css?family=Roboto:400,500,400italic,700' rel='stylesheet' type='text/css'>
<style type="text/css">
<!--
                                              ...
                                              <div class='readMore' data-url="<?php echo U('Index/newsPage',array(id=>$info['if_id']));?>">
                                                <h5>
                                                  <a href="<?php echo U('Index/newsPage',array(id=>$info['if_id']));?>">
                                                    <?php echo ($info["if_theme"]); ?>                                                  </a>                                                </h5>
                                                <p class='text-muted'>
                                                  <?php echo ($info["if_time"]); ?>                                                </p>
                                                <p class='margin-none'>
                                                 <?php echo ($info["if_content"]); ?>                                                </p>
                                              </div>
                                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                 </div>
                                <footer class="data-footer innerAll half text-right clearfix">
                                    <div class="pull-left">
                                        <a href="<?php echo U('Index/home');?>" class="btn btn-inverse btn-sm">返回</a>                                    </div>
