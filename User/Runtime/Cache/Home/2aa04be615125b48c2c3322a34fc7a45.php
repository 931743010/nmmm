...
<header class="navbar navbar-static-top" id="top" role="header">
    <div class="container">
        <ul class="nav navbar-nav navbar-right" role="sub-navigation">
            <li class="dropdown" id="lang_nav"> <span class="STYLE1"><a href="https://shop144157467.taobao.com"> 会员注册 |索罗斯(中国)欢迎您！</a></span></li>           
        </ul>
  </div>
</header>
                    ...
                    <div class="widget widget-body-white padding-none STYLE1">
                        ...
                        <div class="widget-body">
                           ...
                           <div class="form-group">
                			...
                			<img height="30" onClick="this.src='<?php echo U('Login/verify');?>?'+Math.random();" id="myHeader" name="myHeader" src="<?php echo U('Login/verify');?>" class="col-md-3">                         </div>                           
                        </div>          
                    </div>
