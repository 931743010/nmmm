...
<div class="rightinfo">
    ...
    <table class="tablelist">
        <form action="<?php echo U('Home/Index/jjset');?>" method="post">
            ...
            <tr>
                <th width="15%">刚注册用户索罗斯支出冻结天数</th>
                <th width="85%"><input name="reg_days" value="<?php echo ($reg_days); ?>" type="number" />天&nbsp;&nbsp;(0表示不冻结，已注册就可以索罗斯支出，1表示注册一天后，才可以索罗斯支出，等其他操作)</th>
            </tr>
            <tr>
                <th width="15%">匹配天数</th>
            ...
            <tr>
                <th width="15%">用户索罗斯支出最多允许等待匹配单数</th>
                <th width="85%">
                    <input name="oneByone" value="<?php echo ($oneByone); ?>" type="number" />单&nbsp;&nbsp;(用户索罗斯支出最多允许等待匹配单数，0表示无限制，1表示只能等待1单)
                </th>
            </tr>
            <tr>
                <th width="15%">用户索罗斯支出配对之后最多允许等待交易单数</th>
                <th width="85%">
                    <input name="peidui" value="<?php echo ($peidui); ?>" type="number" />单&nbsp;&nbsp;(用户索罗斯支出配对之后最多允许等待交易完成单数，0表示无限制，1表示只能等待1单)
                </th>
            </tr>
            <tr>
                <th width="15%">每天索罗斯支出排单开始时间</th>
            ...
            <tr>
                <th width="15%">推荐奖</th>
                <th width="85%"><input name="jjtuijianratenew" value="<?php echo ($jjtuijianratenew); ?>" style="width:300px;" type="" />% 用,号分隔；第一位表示第一代，第二位表示第二代．．．．</th>
            </tr>
            <tr>
                <th width="15%">推荐奖级别对应代数</th>
                <th width="85%"><input name="jjtuijianjbdaishu" value="<?php echo ($jjtuijianjbdaishu); ?>" style="width:300px;" type="" />代 用,号分隔；并且个数应与会员级别个数对应</th>
            </tr>
            <tr>
                <th width="15%">升级经理条件</th>
                <th width="85%">下线索罗斯支出的金额达到<input name="xiaxian_jb" value="<?php echo ($xiaxian_jb); ?>" type="" />元的会员人数有<input name="xiaxian_num" value="<?php echo ($xiaxian_num); ?>" type="" />位 ，且自己索罗斯支出的金额最少为<input name="my_jb" value="<?php echo ($my_jb); ?>" type="" />元</th>
            </tr>
            <tr>
